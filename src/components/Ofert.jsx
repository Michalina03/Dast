     ...
     <section className="services">
      ...
      <div className="services__cards">
        <div className="services__card">
          <img src={garden} alt="Custom Bouquets" className="services__image" />
          ...
          {/* <button className="services__button">Dowiedz się więcej</button> */}
        </div>

        <div className="services__card">
          <img src={car} alt="Occasion Flowers" className="services__image" />
        ...
        <div className="services__card">
          <img src={machine} alt="Premade Bouquets" className="services__image" />
...
{/* 
    <button className="services__button services__button--accent">Shop now</button> */}
  </div>

  <div className="services__gift-image">
    <img src={foto} alt="Gift ideas" />
  </div>
</div>
...
{/* 
    <button className="services__button services__button--accent">Umów wizytę</button> */}
  </div>
...
<div className="services__gift">
  <div className="services__gift-content">
    ...
    {/* <button className="services__button services__button--accent">Zarezerwuj teraz</button> */}
  </div>
